...
export default function SignInPage() {
  ...
  const { signInWithEmail, signInWithGoogle, signInWithApple, loading, error } =
    useAuthForm();
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <form onSubmit={handleEmailSignIn} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-gray-900 text-white font-medium py-3 rounded-lg hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
          >
