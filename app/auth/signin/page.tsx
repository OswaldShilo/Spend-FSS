      ...
      <div className="flex-1 flex flex-col p-8 lg:p-16">
        <div className="flex justify-between items-center mb-16">
          ...
          <p className="text-sm text-spend-text-gray-500">
            New here?{" "}
            <Link href="/auth/signup" className="font-bold text-primary hover:text-primary/80 transition-colors ml-1">
              Create Account
            </Link>
          </p>
        </div>
        ...
        <div className="flex-1 flex flex-col justify-center max-w-[420px] mx-auto w-full">
          <div className="mb-10">
            <h1 className="text-4xl font-extrabold text-spend-text-gray-900 tracking-tight mb-3">Welcome back</h1>
            <p className="text-spend-text-gray-500 text-lg">Enter your details to access your dashboard.</p>
          </div>
          ...
          <div className="relative mb-10">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-spend-neutral-100"></div>
            </div>
            <div className="relative flex justify-center text-xs font-bold uppercase tracking-widest">
              <span className="bg-white px-4 text-spend-text-gray-400">Or email login</span>
            </div>
          </div>
          ...
          <form onSubmit={onSubmit} className="space-y-5">
            ...
            <div className="group">
              <div className="flex justify-between items-center mb-2 ml-1">
                <label className="block text-xs font-bold text-spend-text-gray-500 uppercase tracking-widest group-focus-within:text-primary transition-colors">
                  Password
                </label>
            ...
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2 py-4 px-4 bg-primary hover:bg-primary/90 text-white font-bold rounded-2xl transition-all mt-8 shadow-xl shadow-primary/20 hover:shadow-primary/30 active:scale-[0.98]"
            >
